...
function guardarPefil(userEmail){
            ...
            success : function(json) {
                ...
                for(i = 0;  i < json.length; i++){
                    ...
                    if(json[i].email==userEmail){
                        ...
                        localStorage.setItem('identificacion', json[i].identification);
                        localStorage.setItem('nombre', json[i].name);
                        localStorage.setItem('email', json[i].email);
                        localStorage.setItem('tipo', json[i].type);
                        localStorage.setItem('zona', json[i].zone);
